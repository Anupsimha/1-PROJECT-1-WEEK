      ...
      <div className='flex items-center justify-center w-[97.5%]'>
        <div className='flex flex-col tracking-widest w-[68%] h-72'>
          ...
          <div className="w-[72%] grid grid-cols-2 gap-2 gap-x-[6px] -mt-4">
            <p className="text-3xl text-left bg-gray-500/55 py-1.5 rounded-lg font-bold w-fit px-6">Web Developer</p>
            <p className="text-3xl text-left bg-gray-500/55 py-1.5 rounded-lg font-bold w-fit px-6">App Developer</p>
            <p className="text-3xl text-left bg-gray-500/55 py-1.5 rounded-lg font-bold w-fit px-6">UI/UX Designer</p>
            <p className="text-3xl w-[114%] text-left bg-gray-500/55 py-1.5 rounded-lg font-bold px-6">Software Developer</p>
          </div>
        </div>
